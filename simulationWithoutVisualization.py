...
class Simulation:
    ...
    def run(self):
        ...
        updateTime = UpdateTime(self, self.simulationTime + 300, gen.allCars, trafficSignals, statisticsHandler,
...
if __name__ == '__main__':
    trafficTimes = getSimulationProperties()
    simulation = Simulation(width=1500, height=750, visualization=pygame.HIDDEN, carVelocity=50,
